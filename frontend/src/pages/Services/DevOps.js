...
import '../../styles/DevOps.css'; // Import the CSS file for the Custom Development page
import Footer from '../../components/Footer'; // Import Footer component
import FAQ from '../../components/FAQ';
import ContactForm from '../../components/ContactForm';
import image1 from '../../assets/images/Services/devops/image1.jpg';
...
const DevOps = () => {
  ...
  return (
    <div className="container">
      ...
      {/* Udevopsated Hero Section with Two Circles and Image */}
   <section className="hero-section">
  <div className="devops-hero-content" data-aos="fade-up">
     <h1>DEVOPS SOLUTIONS FOR EFFICIENT SOFTWARE DELIVERY</h1>
        <p>
          Streamline your development and operations processes with our expert DevOps solutions, ensuring faster time-to-market and higher quality products.
        </p>
    <div className="devops-circle-container">
      <div className="devops-wing-circle devops-left-circle gradient-border" data-aos="fade-up"></div>
      <div className="devops-center-image-circle">
        <img
          src={image1}
          alt="Innovative Solution"
          className="devops-center-image"
        />
      </div>
      <div className="devops-wing-circle devops-right-circle gradient-border" data-aos="fade-up"></div>
    </div>
    <div className="devops-small-circle-wrapper" onClick={scrollToContact}>
      <div className="devops-small-circle gradient-border">
        <span className="devops-arrow">→</span>
      </div>
      <p className="devops-small-circle-text">Get in touch with us</p>
    </div>
  </div>
</section>
      ...
      <h2>OUR DEVOPS JOURNEY</h2>
      <p>
        At AMTB Solutions, we integrate development and operations to deliver continuous software delivery and operational excellence. Here’s how we achieve this:
      </p>
        ...
        <div className="journey-steps">
          <div className="step-item" data-aos="fade-up">
            ...
            <div className="step-content">
              <h3>IDEATION</h3>
            <p>Collaborate to define project scope, requirements, and infrastructure needs with our expert team.</p>
          </div>
          </div>
          <div className="step-item" data-aos="fade-up">
            ...
            <div className="step-content">
            <h3>STRATEGY</h3>
            <p>Develop a strategic plan focusing on automation, monitoring, and CI/CD practices.</p>
          </div>
          </div>
          <div className="step-item" data-aos="fade-up">
            ...
            <p>Ensure user-centered design through continuous feedback loops and iterative improvements.</p>
          </div>
          </div>
          <div className="step-item" data-aos="fade-up">
            ...
            <p>Automate deployment and testing processes to ensure robust and scalable systems.</p>
          </div>
          </div>
          <div className="step-item" data-aos="fade-up">
            ...
            <p>Launch solutions with real-time monitoring to ensure operational excellence.</p>
          </div>
          </div>
          <div className="step-item" data-aos="fade-up">
            ...
            <p>Offer ongoing support, maintenance, and feedback-driven enhancements for sustained success.</p>
          </div>
          </div>
        </div>
      </section>
      ...
      <section className="devops-section">
        ...
        <div className="services-container">
          ...
          <p>
            Implement CI/CD pipelines that automate the integration of code changes and delivery to production, enhancing release speed and quality.
          </p>
            ...
            <div className="devops-service-tags" data-aos="fade-up">
          ...
          <p>
            Manage your infrastructure using code for consistency and repeatability in deployments.
          </p>
             <div className="ss-small-circle-container" onClick={scrollToContact}>
                 <div className="ss-small-circle gradient-border">
                 <span className="ss-arrow">→</span>
          ...
          <p>
            Implement comprehensive monitoring solutions to gain insights into application performance and user experience.
          </p>
             <div className="ss-small-circle-container" onClick={scrollToContact}>
                 <div className="ss-small-circle gradient-border">
                 <span className="ss-arrow">→</span>
          ...
          <p>
            Leverage container technologies to create lightweight, portable applications for seamless deployment across environments.
          </p>
             <div className="ss-small-circle-container" onClick={scrollToContact}>
                 <div className="ss-small-circle gradient-border">
                 <span className="ss-arrow">→</span>
     ...
     <section className="tools-section" data-aos="fade-up">
      ...
      <div className="tools-logos">
        <div className="devops-tool-icon" data-aos="fade-up">
          <FaAws size={50} />
          <p>AWS</p>
        </div>
        <div className="devops-tool-icon" data-aos="fade-up">
...
<section className="devops-industry-section" data-aos="fade-up">
...
<section className="devops-mad-services-section" data-aos="fade-up">
